    ...
    <ul class="nav flex-column">
        <li class="nav-item">
            <a class="nav-link text-white" href="{{ route('home.index') }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="side-icon" viewBox="0 0 20 20">
        ...
        <li class="nav-item">
            <a class="nav-link text-white" href="{{ route('housekeepers.index') }}">
                ...
                <span class="hide">Camareiros</span>
            </a>
        </li>
        @endcan
        <li class="nav-item">
